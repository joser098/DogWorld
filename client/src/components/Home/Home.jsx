    ...
    <div>
      <div className={styles.select_div}>
        ...
        <select className={styles.select} onChange={handleSelectFilter}>
          <option className={styles.option} value="AD">
            All Dogs
          </option>
        ...
        <select className={styles.select} onChange={handleTempsFilter}>
          {temperaments.map((temp) => {
            return (
              <option className={styles.option} value={temp.name}>
                {" "}
                {temp.name}{" "}
              </option>
            );
        ...
        <select className={styles.select} onChange={handleSelectOrder}>
          ...
          <option className={styles.option} value="AxW">
            Min weight
          </option>
          <option className={styles.option} value="DxW">
            Max weight
          </option>
        </select>
      </div>
      ...
      <button className={styles.btn} onClick={prevButtonHandler}>
        {" "}
        ◀ Prev{" "}
      </button>
      <label htmlFor="current">{currentPage}</label>
      <button className={styles.btn} onClick={nextButtonHandler}>
        {" "}
        Next ▶{" "}
      </button>
      <ToastContainer />
